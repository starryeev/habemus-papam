...
public class E40100 : Event
{
    void Reset()
    {
        eventID = "E40100";
        eventName = "소똥구리 토론";
        eventDescription = "장로들이 옹기종기 앉아 소똥구리 한마리를 관찰하고 있다.\n\"그러고 보니, 이 벌레가 똥을 굴리는 모양새가 태양의 운행과 퍽 닮지 않았소이까?\"\n장로들은 돌아가며 자신의 의견을 말했고, 이제 당신의 차례다!";
        maxAppear = 1;

        eventWeightBase = 20f;
        eventWeightMultiplier = 0f;

        option1 = "태양님이 당신의 모습을 본 떠 인간을 빚었듯 태양의 불변함을 이 미물에 담은 것이다.";
        option1Chance = 1f;
        option1Requirement = "경건함 4 이상";
        option1SuccessDescription = "당신의 주장은 큰 지지를 받았다. 장로들은 이 신성한 벌레를 태양충이라 부르기로 했다.\n\n체력 1 증가!\n정치력 1 증가!";
